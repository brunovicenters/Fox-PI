                        ...
                        <span class="absolute top-2 -left-5">
                            <svg class="inline-block w-6 h-6">
                                <circle cx="8" cy="8" r="8"
                                    class="{{ $status == 1 ? 'caminho' : ($status == 2 ? 'entregue' : ($status == 3 ? 'cancelado' : '')) }}" />
                            </svg>
                        </span>
                        <span
                            class="{{ $status == 1 ? 'text-laranja-claro' : ($status == 2 ? 'text-verde' : ($status == 3 ? 'text-vermelho' : '')) }} hanalei text-3xl">{{ $status == 1 ? 'A caminho' : ($status == 2 ? 'Entregue' : ($status == 3 ? 'Cancelado' : '')) }}</span>
                    </p>
            ...
            <div class="flex flex-col space-y-3">
                @for ($i = 1; $i <= 2; $i++)
                    <x-card-horizontal>
                        <div class="pl-2">
                            <img class="w-24 h-32"
                                src="https://img.freepik.com/fotos-gratis/fundo_53876-32170.jpg?w=740&t=st=1710889922~exp=1710890522~hmac=7a5a91fb224ef325005348cdd768218cbc50b49696db300ff345702f6d7b06d6"
                                alt="">
                        </div>
                        <div class="w-3/4 px-3">
                            ...
                            <p class="truncate max-w-xs">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil veritatis odio quasi
                                praesentium! Voluptates distinctio veritatis nesciunt consequatur fugiat molestiae, fuga
                                blanditiis vel hic quis commodi doloribus. Nulla, culpa necessitatibus!
                            </p>
                        </div>
                        <div class="px-3">
