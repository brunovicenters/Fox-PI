    ...
    <section class="max-w-8xl flex justify-center items-right">
        <div class="w-5/6 mt-10 flex gap-8">
            ...
            <div class="flex flex-col gap-3 mt-8 ml-24 poppins  text-vermelho">
                ...
                <form method="POST" action="{{ route('produto.carrinho') }}">
                    @csrf
                    <div
                        class="flex itens-center justify-center rounded-lg  font-bold drop-shadow-md  w-20 h-10 border-2 border-solid btn-add gap-1 text-azul gap-4">
                    ...
                    <div class="flex gap-3 relative">
                        ...
                        <button
                            class="flex itens-center justify-center text-black rounded-lg px-10 py-2 w-1/2 font-bold drop-shadow-md  hover:scale-105 hover:drop-shadow-lg btn-car text-x h-11">
            ...
            <div class="flex gap-2">
                <input name="cep" type="number" placeholder="CEP" title="CEP"
                    class="p-2 rounded-lg drop-shadow-md text-laranja-escuro w-2/3"></input>
                <button
                    class="flex itens-center justify-center rounded-lg px-10 py-2 w-1/3 font-bold drop-shadow-md  hover:scale-105 hover:drop-shadow-lg btn-cep h-11 ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
