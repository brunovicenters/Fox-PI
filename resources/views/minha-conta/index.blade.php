    ...
    <div class="flex w-full justify-between">
        ...
        <div class="w-2/5">
            <div class="flex w-full justify-between items-center mb-5">
                ...
                <a title="Adicione um endereço" href="{{ route("endereco.create", "minha-conta") }}" class="rounded-lg p-1 drop-shadow-md bg-green-700 hover:bg-green-900 hover:scale-105 hover:drop-shadow-lg ease-linear">
