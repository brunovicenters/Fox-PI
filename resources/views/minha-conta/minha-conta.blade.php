<x-layout>
    <section class="max-w-5xl mx-auto flex flex-col items-center h-screen mt-10 poppins  drop-shadow-md space-y-4">
        <div class="flex hanalei gap-9">
            ...
            <div>
                <button type="submit" class="flex items center poppins text-white rounded-lg  px-1  drop-shadow-md bg-btn-sign hover:scale-105 hover:drop-shadow-lg ease-linear h-11 w-11 mt-3">
        ...
        <div class="flex items-right flex-col w-2/5 text-laranja-escuro drop-shadow-md space-y-4">
            ...
            <p class="ml-5">000.000.000-00</p>
            <p><strong>Email:</strong></p>
            <p class="ml-5">E-mail</p>
            <p><strong>Senha:</strong></p>
            <p class="ml-5">Senha</p>
