        ...
        <main>
            <div class="flex flex-col space-y-2">
                ...
                <div class="w-full flex justify-center items-right gap-5">
                    ...
                    <div class="flex flex-col w-5/6">
                        <label class="poppins text-laranja-escuro drop-shadow-md font-semibold">Qual o código do
                            pedido?</label>
                        <input name="codigo" placeholder="Código do pedido" title="Qual o código do pedido"
                            class="p-2 rounded-lg drop-shadow-md text-laranja-escuro w-full"></input>
                    </div>
                </div>
                ...
                <div class="flex justify-center gap-10  w-full">
                    ...
                    <button type="submit"
                        class="poppins text-white rounded-lg px-10 py-2 uppercase font-bold drop-shadow-md bg-btn-sign hover:scale-105 hover:drop-shadow-lg ease-linear h-11 mt-6 ">Enviar</button>
