<main class="navbar w-full h-28 relative flex gap-16">
    ...
    <div class="w-2/4 mt-3">
        <nav class="flex items-center gap-3 text-white">
            ...
            |
            <a href="/" class="hanalei uppercase menu-nav text-lg">
                Rua Lugar Algum, 761 - 04562-708
            </a>
            |
            <a href="/" class="hanalei uppercase menu-nav">Fale conosco</a>
            |
            <div class="flex gap-2 justify-center items-center">
                <a href="/" class="menu-nav">
                    <svg class="w-5 icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <form action="#" method="get" class="mt-3 relative">
            <div class="w-full relative">
                ...
                <button type="submit" class="absolute right-3 top-1 rotate-90 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="#D36411" class="w-8 h-8 rounded-full p-1 search">
    ...
    <div class="flex gap-10 justify-center items-center pr-20">
        <a class="relative pointer" href="/carrinho">
            <span class="absolute -top-3 -left-2 text-xl rounded-full text-center w-8 h-8 p-1 z-50 text-amarelo shopcart-icon-number">0</span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-16 h-16 -scale-x-100">
