<main class="navbar w-full h-28 relative flex gap-16">
    ...
    <div class="w-2/4 mt-3">
        <nav class="flex items-center gap-3 text-white">
            ...
            |
            <p class="hanalei uppercase menu-nav text-lg">
    ...
    <div class="flex gap-10 justify-center items-center pr-20">
        <a class="relative pointer" href="/carrinho">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-16 h-16 -scale-x-100 icon-stroke">
        ...
        <div class="relative">
            <div class="relative">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-20 h-20 icon-stroke">
