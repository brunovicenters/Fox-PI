        ...
        <div class="footer-top flex justify-between">
            ...
            <div class="footer-conta">
                ...
                <ul>
                    ...
                    <li class="poppins text-verde">
                        <a href="/meus-pedidos" class="hover:underline">Sair</a>
                    </li>
                </ul>
            </div>
                ...
                <div>
                    ...
                    <div class="footer-card rounded-lg flex space-x-2 py-2 px-3">
                        <div class="footer-card-icon flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#B20D30" class="w-10 h-10">
                        ...
                        <div class="footer-card-text flex flex-col">
                            ...
                            <p class="text-verde poppins text-xs uppercase">&#40;Exceto feriado e emenda de feriado&#41;</p>
                        </div>
                    </div>
                </div>
                {{-- SAC --}}
        ...
        <div class="footer-bottom flex justify-center items-center space-x-8">
            <div class="flex flex-col">
                ...
                <div class="footer-payment flex space-x-4">
                    ...
                    <div class="footer-card rounded-lg flex items-center flex-col px-4 py-1 w-20 h-16">
                        <p class="poppins text-vermelho text-center">Débito</p>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-6 h-6" fill="#B20D30">
                    ...
                    <div class="footer-card rounded-lg flex items-center flex-col px-4 py-1 w-20 h-16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#B20D30" class="w-6 h-6">
            ...
            <div class="footer-social">
                ...
                <div class="flex space-x-4">
                    <a href="#" class="footer-card rounded-lg flex items-center justify-center w-16 h-16 hover:scale-105">
                        <p class="menu-nav">
                    ...
                    <a href="#" class="footer-card rounded-lg flex items-center justify-center w-16 h-16 hover:scale-105">
                        <p class="menu-nav">
                            <svg class="w-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="#B20D30">
