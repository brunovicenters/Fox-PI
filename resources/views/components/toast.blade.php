...
@if ($type == 'error')
    ...
    <div id="toast-danger" class="absolute bottom-1 right-2 flex items-center w-full max-w-xs p-4 mb-4 text-red-800 bg-red-300 rounded-lg shadow toasts z-50" role="alert">
...
@elseif ($type == 'success')
    ...
    <div id="toast-success" class="absolute bottom-1 right-3 flex items-center w-full max-w-xs p-4 mb-4 text-green-800 bg-green-300 rounded-lg shadow toasts z-50" role="alert">
...
@elseif ($type == 'alert')
    ...
    <div id="toast-warning" class="absolute bottom-1 right-3 flex items-center w-full max-w-xs p-4 mb-4 text-orange-700 bg-orange-300 rounded-lg shadow toasts z-50" role="alert">
